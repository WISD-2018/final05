    ...
    <div id="st1" class="st">
        <div class="inner">
            <div class="grid-container">
                ...
                <a href="{{url('onedayplanA')}}"><h1><font color="#ffffff" size="5" face="微軟正黑體"><b>七美一日遊</b></font></h1></a>
                </div>
                <div class="grid-item">
                    <div id="circular--landscape-1">
                        <div id="circular--landscape-1 img">
                            <a><img src="img/view21.jpg"></a>
                        </div>
                    </div>
                    <a href="{{url('onedayplanB')}}"><h1><font color="#ffffff" size="5" face="微軟正黑體"><b>本島漫遊之旅</b></font></h1></a>
                </div>
                <div class="grid-item">
                    <div id="circular--landscape-1">
                        <div id="circular--landscape-1 img">
                    ...
                    <a href="{{url('onedayplanC')}}"><h1><font color="#ffffff" size="5" face="微軟正黑體"><b>澎湖自然文化之旅</b></font></h1></a>
                </div>
                <div class="grid-item">
